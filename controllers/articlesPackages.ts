...
// GET all ArtPack
const getAllArtPack = (async (req: Request, res: Response, next: NextFunction) => {
    try {
  ...
  // GET ArtPack by id
const getOneArtPack = (async (req: Request, res: Response, next: NextFunction) => {
    try {
  ...
  // PUT ArtPack
  const updateArtPack = (async (req: Request, res: Response, next: NextFunction) => {
    try {
      const { idArtPack } = req.params;
      const artPackUpdated = await ArticlePackage.updateArtPack(Number(idArtPack), req.body as IArticlePackage); // => boolean
      if (artPackUpdated) {
        const artPack = await ArticlePackage.getArtPackById(Number(idArtPack));
  ...
  // DELETE artPack
  const deleteArtPack = (async (req: Request, res: Response, next: NextFunction) => {
    try {
      const { idArtPack } = req.params;
      const artPack = await ArticlePackage.getArtPackById(Number(idArtPack));
      const artPackDeleted = await ArticlePackage.deleteArtPack(Number(idArtPack)); // => boolean
      if(artPackDeleted) {
  ...
  export default { getAllArtPack, getOneArtPack, addArtPack, updateArtPack, deleteArtPack };