...
VALUES ("Blockchain", "Ceci est de la blockchain"),
("Bitcoin", "Votez Elon Musk"),
("Introduction", "Les bases des cryptomonnaies et de la blockain juste pour vous et aussi un peu pour les autres");
